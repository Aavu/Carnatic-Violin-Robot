...
public:
    ...
    inline static const std::string kName = "CFft";
    ...
    */
    ...
    \return Error_t
    */
    [[maybe_unused]] Error_t overrideWindow (const float *pfNewWindow);
    /*! retrieve current window
    \param float * pfWindow: window data of length iBlockLength (\sa initInstance)
    \return Error_t
    */
    [[maybe_unused]] Error_t getWindow (float *pfWindow) const;
    ...
    \return Error_t
    */
    [[maybe_unused]] Error_t doFft (complex_t *pfSpectrum, const float *pfInput);
    /*! perform IFFT
    ...
    \return Error_t
    */
    [[maybe_unused]] Error_t doInvFft (float *pfOutput, const complex_t *pfSpectrum);
    ...
    */
    ...
    \return Error_t
    */
    [[maybe_unused]] Error_t getPhase(float *pfPhase, const complex_t *pfSpectrum) const;
    ...
    \return Error_t
    */
    [[maybe_unused]] Error_t splitRealImag(float *pfReal, float *pfImag, const complex_t *pfSpectrum) const;
    ...
    \return Error_t
    */
    [[maybe_unused]] Error_t mergeRealImag(complex_t *pfSpectrum, const float *pfReal, const float *pfImag) const;
    ...
    \return int
    */
    [[nodiscard]] int getLength(Length_t eLengthIdx) const;
    ...
    */
    [[nodiscard]] [[maybe_unused]] float freq2bin (float fFreqInHz, float fSampleRateInHz) const;
    /*! convert bin to frequency
    \param int iBinIdx: index of the FFT bin
    \param float fSampleRateInHz: sample rate of the audio signal
    \return float: frequency in Hz
    */
    [[nodiscard]] float bin2freq (float fBinIdx, float fSampleRateInHz) const;

    static float interpolate (float* pfBuffer, int iIndex, int iSize);

    static float freq2note(float fFreq);
