...
class RMVPE:
    ...
    def mel2hidden(self, mel):
        with torch.no_grad():
            ...
            padding_size = 32 * ((n_frames - 1) // 32 + 1) - n_frames
            # while padding_size >= n_frames:
            #     mel = F.pad(mel, (0, n_frames - 1), mode="reflect")
            #     nf = mel.shape[-1]
            #     padding_size = 32 * ((nf - 1) // 32 + 1) - nf
            # print(mel.shape, padding_size, n_frames)
            mel = F.pad(mel, (0, padding_size), mode="constant")
