...
#ifndef CARNATICVIOLINIST_EPOSCONTROLLER_H
#define CARNATICVIOLINIST_EPOSCONTROLLER_H
...
public:
    ...
    Error_t MoveToPosition(long lPos, unsigned long ulAcc, BOOL bAbsolute);
...
#endif //CARNATICVIOLINIST_EPOSCONTROLLER_H
